...
def show():
    ...
    for prop in summary["Property"].unique():
        ...
        fig.update_layout(
            title=f"{prop} – Monthly Summary (by Rental Start)",
            barmode="group",
            xaxis_title="Month",
            yaxis_title="Amount ($)"
        )
